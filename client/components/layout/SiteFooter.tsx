...
export default function SiteFooter() {
  ...
  <div className="flex items-center gap-2">
    {/* Tambah logo universitas di sebelah kiri paling */}
    <img 
    ...
    />
    {/* Tambah logo fakultas di sebelah kanan logo universitas */}
    <img 
    ...
    <img 
      ...
      className="size-8 rounded-full object-cover"  // Tambah object-cover biar fit sempurna
    />
